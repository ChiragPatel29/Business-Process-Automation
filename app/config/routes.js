function RegisterRoutes() {
    return {
        ...
        easyRoutes: ['organizations', 'users', 'groups', 'categories', 'tasks','profiles','projects','user_stories','leaves','timesheets','bugs','milestones','departments','designations'], // Provide the names of your tables here and make a copy of app/modules/tasks with the same name
        autoRoutes: ['user_groups'
