...
app.controller('designationsControllerExtension', function($scope, $controller, $rootScope,$route, $http, $location, Popup, H, M) {
    ...
    $scope.remove=function(id){
        ...
        $http.put(H.S.baseUrl + '/designations/' + id,data).then(function(res)
        {
                // console.log(data);
                $route.reload();
        },
